...
BOOST_AUTO_TEST_SUITE(Test_GenerateSetOfPrimes_function)
	...
	BOOST_AUTO_TEST_SUITE(Test_limint_values_of_upperBound_parameter)
		...
		{
			std::set<size_t>  mustBeEmptySet = GenerateSetOfPrimes(0);
		...
		BOOST_AUTO_TEST_SUITE(Test_for_two_digit_upperBound_parametr)
			...
			{
				resultSet.insert(7);
				BOOST_CHECK(resultSet == GenerateSetOfPrimes(10));
			}
