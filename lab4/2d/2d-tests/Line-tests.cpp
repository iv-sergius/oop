...
BOOST_AUTO_TEST_SUITE(LineSegment)
	BOOST_AUTO_TEST_SUITE(constructor)
		...
		BOOST_AUTO_TEST_SUITE(throw_exeption_on)
			...
			{
				CPoint point1, point2;
				BOOST_REQUIRE_THROW(CLineSegment line(point1, point2, "#EEEEE"), std::invalid_argument);
			}
			BOOST_AUTO_TEST_CASE(incorrect_length_of_color_string)
			{
				CPoint point1, point2;
				BOOST_REQUIRE_THROW(CLineSegment line(point1, point2, "1234567"), std::invalid_argument);
			}
